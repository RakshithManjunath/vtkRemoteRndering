...
from protocols import UserDefinedProtocols
...
class RemoteRender(vtk_wslink.ServerProtocol):
    ...
    def initialize(self):
        ...
        self.registerVtkWebProtocol(UserDefinedProtocols(self.view_ids))
        ...
        if not RemoteRender.vr_view:
            ...
            reader.SetDirectoryName("/home/rakshith/Documents/RemoteRendering/Dataset/Circle of Willis")
...
if __name__ == "__main__":
    ...
    # Start server
    server.start_webserver(options=args, protocol=RemoteRender, disableLogging=True)